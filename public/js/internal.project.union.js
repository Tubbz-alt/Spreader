...
Spreader.Project = {
    ...
    reactRender: function reactRender() {
            ...
            render: function render() {
                var tasksListNode = this.props.tasks.map((function (task, key) {
                    if (task.activity_id == this.props.activity.id) {
                        ...
                        var userNode = task.amigo_id > 0 ? React.createElement(
                            'a',
                            { href: amigoLink },
                            ...
                            'span',
                            null,
                            React.createElement('i', { className: 'fa fa-user-times' }),
                            ' ？？？'
                        );
                        ...
                        return React.createElement(
                            ...
                            React.createElement(
                                'a',
                                { href: termLink },
                                React.createElement('i', { 'class': 'fa fa-flag' }),
                                ' ',
                                task.term_name
                            ),
                            ' ',
        ...
        var project = this.project,
            ...
            textareaAtwho: function textareaAtwho() {
                var cachequeryMentions = [],
                    ...
                    displayTpl: "<li>${name}</li>",
                    callbacks: {
                        remoteFilter: function remoteFilter(query, render_view) {
                            var thisVal = query,
                                self = $(this);
            ...
            render: function render() {
                ...
                switch (this.state.action) {
                    case 'mv':
                        return React.createElement(ActivityRow, { activity: this.state.activity, tasks: this.state.tasks });

                    case 'cancel':
                        return React.createElement(ActivityRow, { activity: activity, tasks: this.props.tasks });

                    case 'rm':
                        return null;

                    default:
                        return activity.id > 0 ? React.createElement(
                            'tr',
                            null,
                            React.createElement(
                                'th',
                            ...
                            React.createElement(
                                ...
                                React.createElement('input', { type: 'text', name: 'deadline', ref: 'deadline', className: 'form-control input-sm form-error', value: activity.deadline, 'data-provide': 'datepicker', 'data-date-format': 'yyyy-mm-dd', 'data-date-autoclose': 'true' }),
                                React.createElement(
                                    'p',
                            ...
                            React.createElement(
                                'td',
                                { className: tasksTemplateError },
                                React.createElement(
                                    'textarea',
                                    { id: '', name: 'tasks_template', ref: 'tasks_template', cols: '30', rows: '5', className: 'form-control input-sm', placeholder: '#场景 @人员 $报酬 =传单数 任务描述' },
                                    activity.tasks_template
                                ),
                                React.createElement(
                                    'p',
                                    { className: 'help-block' },
                                    this.state.errors.tasks_template
                                )
                            ),
                            React.createElement(
                                'td',
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    'a',
                                    { onClick: this.handleClickUpdate, href: '#' },
                                    '更新'
                                ),
                                React.createElement('br', null),
                                React.createElement(
                                    'a',
                                    { className: 'text-danger', onClick: this.handleClickCancel, href: '#' },
                                    '取消'
                                )
                            )
                        ) : React.createElement(
                            ...
                            React.createElement(
                                'td',
                                { className: deadlineError },
                                React.createElement('input', { type: 'text', name: 'deadline', ref: 'deadline', className: 'form-control input-sm form-error', 'data-provide': 'datepicker', 'data-date-format': 'yyyy-mm-dd', 'data-date-autoclose': 'true' }),
                                React.createElement(
                                    'p',
                                    { className: 'help-block' },
                                    this.state.errors.deadline
                            ...
                            React.createElement(
                                'td',
                                { className: tasksTemplateError },
                                React.createElement('textarea', { id: '', name: 'tasks_template', ref: 'tasks_template', cols: '30', rows: '5', className: 'form-control input-sm', placeholder: '#场景 @人员 $报酬 =传单数 任务描述' }),
                                React.createElement(
                                    'p',
                                    { className: 'help-block' },
                                    this.state.errors.tasks_template
        ...
        var ActivityRow = React.createClass({
            ...
            render: function render() {
                ...
                if (activity.id == 0 || this.state.actionEdit) {
                    return React.createElement(ActivityForm, { activity: activity, tasks: tasks });
                }
                return React.createElement(
                    'tr',
                    null,
                    ...
                    React.createElement(TasksList, { activity: activity, tasks: this.props.tasks }),
                    React.createElement(
                        'td',
                        null,
                        activity.status
        ...
        var activities = this.activities,
            ...
            render: function render() {
                var activityNodes = this.state.activities.map(function (activity, key) {
                    return React.createElement(ActivityRow, { activity: activity, tasks: tasks });
                });
...
//# sourceMappingURL=internal.project.union.js.map
